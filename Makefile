...
# EXT2安装的分区自第73000个扇区开始
# EXT2的superblock位于距起始点1024个字节处，目前一个扇区大小为512个字节，故设在第2个扇区（73002）
# 73002×512 = 37377024
#EXT2_FS_START_OFFSET = 37376512
#EXT2_FS_START_OFFSET = 37377080
EXT2_FS_START_OFFSET = 37377080
...
$(IMAGE): 	$(OBJDIR)/boot/mbr.bin		\
	...
	@dd if=$(OBJDIR)/fs_flags/ext2_flag.bin of=$@ bs=1 count=11 seek=$(EXT2_FS_START_OFFSET) conv=notrunc
